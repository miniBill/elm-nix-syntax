module Nix.Syntax.Node exposing
    ( Node(..)
...
The purpose of this type is to add the information of the [`Range`](./Nix-Syntax-Range), i.e. where in the source code the
...
import Nix.Syntax.Range as Range exposing (Range)
